...
export const settingsSchema = async (): Promise<SettingSchemaDesc[]> => [
  ...
  },
  {
    ...
    description:
      t("Create an API key at https://omnivore.app/settings/api"),
    default: '',
  },
  {
    key: 'filter',
  ...
  },
  {
    ...
    type: 'string',
    title:
      t("Enter an Omnivore custom search query if advanced filter is selected"),
    description:
      t("See https://docs.omnivore.app/using/search.html for more info on search query syntax"),
    default: '',
  },
  {
    key: 'highlightOrder',
  ...
  },
  {
    ...
    description:
      t("Sync all articles to a single page. If this is not selected, each article will be synced to a separate page."),
    default: true,
  },
  {
    key: 'createTemplate',
    ...
    default: '',
    description: t("If the above item is off, want to sync to a separate page for each article, use the variable `{{{title}}}`, `{{{date}}}` or `{{{currentDate}}}` as the page name. For example, `{{{title}}}` will create a page for each article with the title of the article."),
  },
  {
    ...
    title: '',
    default: '',
    description: t("[> Refer to this doc for more info](https://docs.omnivore.app/integrations/logseq.html#controlling-the-layout-of-the-data-imported-to-logseq) [> Variables available could be found here](https://docs.omnivore.app/integrations/logseq.html#variables-available-to-the-highlight-template)"),
  },
  {
    key: 'articleTemplate',
    type: 'string',
    ...
    description:
      t("The template to use for new articles."),
  ...
  },
  {
    ...
    description:
      t("The template to use for new highlights."),
  ...
  },
  {
    ...
    description:
      t("In minutes here or 0 to disable"),
    default: 60,
  },
  {
    key: 'syncAt',
    ...
    title: t("Last Sync"),
    description:
      t("The last time Omnivore was synced. Clear this value to completely refresh the sync."),
    default: '',
  ...
  },
  {
    ...
    description:
      t("This page will be created if it does not exist."),
    default: 'Omnivore',
  },
  {
    key: 'endpoint',
    ...
    description: t("Enter the Omnivore server's API endpoint here (default: https://api-prod.omnivore.app/api/graphql )"),
